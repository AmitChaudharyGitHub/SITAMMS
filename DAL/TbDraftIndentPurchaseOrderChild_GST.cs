...
namespace MMS.DAL
{
    ...
    public partial class TbDraftIndentPurchaseOrderChild_GST
    {
        ...
        public Nullable<int> OldMId { get; set; }
        public string Status { get; set; }
        public Nullable<decimal> TCS_Rate { get; set; }
        public Nullable<decimal> TotalTCSAmount { get; set; }
        public Nullable<decimal> TotalGrosssAmount { get; set; }
    }
}
