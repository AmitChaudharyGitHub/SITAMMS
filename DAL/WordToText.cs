...
namespace MMS.DAL
{
    ...
    {
        public string AmtToWord;

        public string Cal(decimal Amount)
        {
            //double d = 125.85;
            decimal d = Amount;
            int i = (int)d;
            ...
            string text = NumberToText(i, true, false) + " Rupees " + " and " + NumberToText(Convert.ToInt32(decimalPart), true, false) + " Paisa Only ";
            return text;
        }
        ...
        public static string NumberToText(int number, bool useAnd, bool useArab)
        {
            ...
            string and = useAnd ? "" : ""; // deals with using 'and' separator
