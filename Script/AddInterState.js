$(document).ready(function () {
    ...
    $("#ddlProject").change(function () {
        ...
        if ($("#ddlProject option:selected").val() != "0") {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: { ProjectId: $("#ddlProject option:selected").val(), TransferType: 'Inter' },
                complete: function () {
    ...
    $("#addNew").click(function () {
        ...
        obj.InterStateTransferNumber = $("#txtTransferNumber").val();
        ...
        if (gridList.findIndex(s=>s.ItemId == obj.ItemId) > -1) {
    ...
    $("#txtTransferDate").change(function () {
        ...
        $.ajax({
            ...
            data: { ProjectId: $("#ddlProject option:selected").val(), TransferType: "IS", TransferDate: $("#txtTransferDate").val() },
            ...
            success: function (obj) {
                obj = $.parseJSON(obj)
                $("#txtTransferNumber").val(obj.TransferCode);
                $('#txtLastDate').text(obj.Last_ISDate);
                $('#txtLastNo').text(obj.Last_IsNo);
        ...
        if (DQt >= 0)
        {
            if (+DQt <= +SQt) {
                ...
                if (DelivrRate > 0 || DelivrRate == 0) {
                    ...
                    $("#txtBalanceQty").val(BQt.toFixed(3));
                }
                else {
...
function getMaster() {
    ...
    obj1.InterTransferNumber = $("#txtTransferNumber").val();
    ...
    obj1.GRNumber = $("#txtGRNo").val();
    obj1.TransferDate = $("#txtTransferDate").val();
    obj1.Remarks = $("#txtRemarks").val();
    obj1.ForwardToPIC = $("#SendTo option:selected").val();
...
function ValidMaster() {
    ...
    var InterTransferNumber = $("#txtTransferNumber").val();
...
function EmpityMaster()
{
     ...
     $("#txtTransferDate").val('');
     $("#txtRemarks").val('');
     $("#SendTo option:selected").prop("selected", false);
     $("#txtdateofdestination").prop("selected", false);
     $("#txtdateofdestination").val('');
