...
$(document).ready(function () {
    ...
    $('#btnsave').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json.Status == "1") {
                    alert("Data Saved Successfully. Transaction No. " + json.TransNo);
    ...
    function Valid() {
        ...
        if (PoNo == "") {
            alert('P.O No. can not be empty. Please select date again to generate P.O Number.');
    ...
    function GetVendor(data) {
        ...
        var markup = "<option value='0'>Select Project Site Name</option>";
    ...
    $("#Date").change(function () {
        ...
        $.ajax({
            ...
            data: { ProjID: $("#hdn_purchase_project_Id").val(), PurReqNo: $("#hdn_purch_indent_no_ber").val(), PODate: $("#Date").val() },
