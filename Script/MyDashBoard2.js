$(document).ready(function () {
    ...
    app.controller('myCtrl', function ($scope) {
        ...
        //    $.get(GetPO, { Status: 'Pending', Stage: 'PIC' }, function (response) {
        //        if (response.Status == 1) {
        ...
        //    $.get(GetPO, { Status: 'Pending', Stage: 'Cluster' }, function (response) {
        //        if (response.Status == 1) {
        ...
        //    $.get(GetPO, { Status: 'Pending', Stage: 'PMC' }, function (response) {
        //        if (response.Status == 1) {
        ...
        //    $.get(GetPO, {Type:'Transfer', Status: 'Disapproved', Stage: 'Purchaser' }, function (response) {
        //        if (response.Status == 1) {
        ...
        //    $.get(GetPO, {Status: 'NoRelease', Stage: '' }, function (response) {
        //        if (response.Status == 1) {
